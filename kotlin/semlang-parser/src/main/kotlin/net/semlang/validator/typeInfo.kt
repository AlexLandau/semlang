...
// TODO: Replace with calling the others (or have users use the others)
fun getTypesInfo(context: RawContext, moduleId: ModuleUniqueId, upstreamModules: List<ValidatedModule>, moduleVersionMappings: Map<ModuleNonUniqueId, ModuleUniqueId>, recordIssue: (Issue) -> Unit): TypesInfo {
    return TypeInfoCollector(context, moduleId, upstreamModules, moduleVersionMappings, recordIssue).apply()
}
...
// TODO: Replace with something that turns a TypesSummary into a TypesInfo
